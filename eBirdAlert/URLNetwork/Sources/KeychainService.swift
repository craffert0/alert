...
public struct KeychainService: Sendable {
    public static let global = KeychainService()

    private static let server = "api.ebird.org"
    ...
    public var applicationKey: String? {
        get throws {
            ...
            return applicationKey.isEmpty ? nil : applicationKey
        }
    }

    public func set(applicationKey: String) throws {
